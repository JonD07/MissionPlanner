...
bool TighteningHeuristic::ImproveSubTour(int l, Input* input, std::vector<Point>* sub_tour, bool use_heuristic) {
	...
	if(use_heuristic) {
		...
		// Don't use the heuristic... this just means we want to check energy constraints
		if(DEBUG_HL_TH_LV1)
			printf("Only check energy usage\n");
	}
